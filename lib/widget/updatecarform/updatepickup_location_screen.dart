...
class UpdatePickupLocationScreen extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final Function onNext;
  final Function(String?) onPickupLocationChanged; // Add this
  final String? pickupLocation;

  const UpdatePickupLocationScreen({
    super.key,
  ...
  @override
  UpdatePickupLocationScreenState createState() =>
      UpdatePickupLocationScreenState();
}

class UpdatePickupLocationScreenState
    extends State<UpdatePickupLocationScreen> {
