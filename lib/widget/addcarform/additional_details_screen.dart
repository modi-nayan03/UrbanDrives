...
class AdditionalDetailsScreen extends StatefulWidget {
  ...
  const AdditionalDetailsScreen({
    ...
    String? pricePerHour, required bool enabled,
  });

  @override
  AdditionalDetailsScreenState createState() => AdditionalDetailsScreenState();
}

class AdditionalDetailsScreenState extends State<AdditionalDetailsScreen> {
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      ...
                      widget.onFuelTypeChanged('Diesel');
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      widget.onFuelTypeChanged('Petrol');
                    },
                    style: ElevatedButton.styleFrom(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      widget.onFuelTypeChanged('HYBRID');
                    },
                    style: ElevatedButton.styleFrom(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        widget.onTransmissionTypeChanged('Automatic');
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            _selectedTransmissionType == 'Automatic'
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        widget.onTransmissionTypeChanged('Manual');
                      },
                      style: ElevatedButton.styleFrom(
